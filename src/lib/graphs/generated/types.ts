...
export interface MutationSignInWithCredentialArgs {
...
export interface MutationSignUpWithCredentialArgs {
	input: SignUpWithCredentialInput
}

export interface MutationUpdateIconArgs {
...
export interface SignInWithCredentialInput {
	email:    Scalars['String']['input']
	password: Scalars['String']['input']
}
...
/** input */
export interface SignUpWithCredentialInput {
	confirmPassword: Scalars['String']['input']
	email:           Scalars['String']['input']
	password:        Scalars['String']['input']
	username:        Scalars['String']['input']
...
export interface SignInWithCredentialMutation { __typename?: 'Mutation', payload: { __typename?: 'SignInPayload', username: string, token: string } }

export type SignInWithSocialMutationVariables = Exact<{
	input: SignInWithSocialInput
}>

export interface SignInWithSocialMutation { __typename?: 'Mutation', payload: { __typename?: 'SignInPayload', username: string, token: string } }

export type SignUpWithCredentialMutationVariables = Exact<{
	input: SignUpWithCredentialInput
}>

export interface SignUpWithCredentialMutation { __typename?: 'Mutation', payload: { __typename?: 'SignUpPayload', isSuccess: boolean } }

export type GetHolidaysQueryVariables = Exact<{ [key: string]: never }>

export interface GetHolidaysQuery { __typename?: 'Query', holidays: Array<any> }

export type GetNowInJstQueryVariables = Exact<{ [key: string]: never }>

export interface GetNowInJstQuery { __typename?: 'Query', nowInJST: any }

export type HealthCheckForBackendQueryVariables = Exact<{ [key: string]: never }>

export interface HealthCheckForBackendQuery { __typename?: 'Query', healthCheckForBackend: string }
...
export interface ResolversInterfaceTypes<_RefType extends Record<string, unknown>> {
...
export interface BasePayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['BasePayload'] = ResolversParentTypes['BasePayload']> {
...
export interface CreateUserPayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['CreateUserPayload'] = ResolversParentTypes['CreateUserPayload']> {
	isSuccess:   Resolver<ResolversTypes['Boolean'], ParentType, ContextType>
...
export interface IconResolvers<ContextType = any, ParentType extends ResolversParentTypes['Icon'] = ResolversParentTypes['Icon']> {
...
export interface SignInPayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['SignInPayload'] = ResolversParentTypes['SignInPayload']> {
	token:       Resolver<ResolversTypes['String'], ParentType, ContextType>
	username:    Resolver<ResolversTypes['String'], ParentType, ContextType>
	__isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
}

export interface SignUpPayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['SignUpPayload'] = ResolversParentTypes['SignUpPayload']> {
	isSuccess:   Resolver<ResolversTypes['Boolean'], ParentType, ContextType>
	__isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
}
